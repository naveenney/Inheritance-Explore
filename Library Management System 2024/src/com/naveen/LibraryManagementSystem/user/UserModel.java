...
class UserModel {
	  ...
	  public void setUserDetails(int id,String name,String phoneNo,String mailId,String address)
	  {   
		 if(validateUser(id,name,phoneNo,mailId))
		 {
		  ...
		  DataLayer.getInstance().insertUserDetails(user);
		  }
	   ...
	   private boolean validateUser(int id,String name,String phoneNo,String mailId)
	   {
		 if(!validateId(id))
		      return false;
